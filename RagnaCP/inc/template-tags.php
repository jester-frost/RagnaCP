...
function twentyfifteen_entry_meta() {
	...
	if ( current_theme_supports( 'post-formats', $format ) ) {
		printf( '<span class="entry-format">%1$s<a href="%2$s">%3$s</a></span>',
			sprintf( '<span class="screen-reader-text">%s </span>', _x( 'Formato', 'Used before post format.', 'twentyfifteen' ) ),
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		printf( '<span class="Postado-em"><span class="screen-reader-text">%1$s </span><a href="%2$s" rel="bookmark">%3$s</a></span>',
			_x( 'Postado em', 'Used before publish date.', 'twentyfifteen' ),
	...
	if ( 'post' == get_post_type() ) {
		if ( is_singular() || is_multi_author() ) {
			printf( '<span class="byline"><span class="author vcard"><span class="screen-reader-text">%1$s </span><a class="url fn n" href="%2$s">%3$s</a></span></span>',
				_x( 'Autor', 'Used before post author name.', 'twentyfifteen' ),
		...
		if ( $categories_list && twentyfifteen_categorized_blog() ) {
			printf( '<span class="cat-links"><span class="screen-reader-text">%1$s </span>%2$s</span>',
				_x( 'Categorias', 'Used before category names.', 'twentyfifteen' ),
				$categories_list
			);
		}
