...
if ( !class_exists( 'ragna_theme' ) ) :
    ...
    class ragna_theme {
        ...
        function scripts_e_estilos() {
            // Javascript
            wp_enqueue_script( 'ragna_scripts', get_stylesheet_directory_uri() . '/js/ragna.js', array( 'jquery' ), '0.01', true );
            wp_enqueue_script( 'ragna_scripts', get_stylesheet_directory_uri() . '/js/html5shiv.min.js', array( 'jquery' ), '0.01', true );
            // CSS Normalize
